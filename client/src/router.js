...
import UserPage from './pages/User_page/user_p'; // Caminho atualizado e verificado
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/user-config" element={<UserPage />} /> {/* Certifique-se de que esse é o caminho correto */}
            </Routes>
        </Router>
    );
};
